...
class MxArray
{
  public:
     ...
     * @endcode
     */
    cv::Mat toMat(int depth = CV_USERTYPE1, bool transpose = true) const;
     ...
     * @endcode
     */
    cv::MatND toMatND(int depth = CV_USERTYPE1, bool transpose = true) const;
     ...
     */
    cv::SparseMat toSparseMat(int depth = CV_USERTYPE1) const;
